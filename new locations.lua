...
local interactables = {
    ["Bait Crate"] = {Position = Vector3.new(383.891144, 136.994125, 333.777832), Rotation = Vector3.new(180.000000, -9.743000, 180.000000)},
    ["Quality Bait Crate"] = {Position = Vector3.new(-174.103439, 143.167511, 1931.018066), Rotation = Vector3.new(180.000000, 67.754997, 180.000000)},
    ["Crab Cage"] = {Position = Vector3.new(474.081421, 150.500000, 233.840317), Rotation = Vector3.new(0.000000, -11.755000, 0.000000)},
    ["GPS"] = {Position = Vector3.new(518.683594, 150.477036, 282.772186), Rotation = Vector3.new(180.000000, -11.407000, 180.000000)},
    ["Radar"] = {Position = Vector3.new(365.751770, 137.000015, 274.103027), Rotation = Vector3.new(0.000000, 0.001000, 0.000000)},
    ["Basic Diving gear"] = {Position = Vector3.new(369.762268, 134.456268, 248.701965), Rotation = Vector3.new(0.000000, 0.456000, 0.000000)},
    ["Advanced Diving gear"] = nil,
    ["Tidebreaker"] = nil
}

local totems = {
    ["Aurora"] = {Position = Vector3.new(-1811.000000, -136.927933, -3282.000000), Rotation = Vector3.new(0.000000, 0.000000, 0.000000)},
    ["Smokescreen"] = {Position = Vector3.new(2789.000000, 139.825485, -625.000000), Rotation = Vector3.new(0.000000, 0.000000, 0.000000)},
    ["Windset"] = {Position = Vector3.new(2849.000000, 178.333237, 2702.000000), Rotation = Vector3.new(0.000000, 0.000000, 0.000000)},
    ["Tempest"] = {Position = Vector3.new(35.000000, 132.500015, 1943.000000), Rotation = Vector3.new(0.000000, 0.000000, 0.000000)},
    ["Sundial"] = {Position = Vector3.new(-1148.000000, 134.499985, -1075.000000), Rotation = Vector3.new(0.000000, 0.000000, 0.000000)},
    ["Eclipse"] = {Position = Vector3.new(5968.000000, 273.752777, 838.000000), Rotation = Vector3.new(0.000000, 0.000000, 0.000000)},
    ["Meteor"] = {Position = Vector3.new(-1948.000000, 275.356720, 230.000000), Rotation = Vector3.new(0.000000, 0.000000, 0.000000)}
}
